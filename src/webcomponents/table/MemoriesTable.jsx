...
const MemoriesTable = () => {
  ...
  const [data, setData] = useState([
    { id: 1, title: "Untitled", status: "Completed" },
    { id: 2, title: "Untitled", status: "Pending" },
    { id: 3, title: "Untitled", status: "Completed" },
    { id: 4, title: "Untitled", status: "Pending" },
    { id: 5, title: "Untitled", status: "Completed" },
  ]);
